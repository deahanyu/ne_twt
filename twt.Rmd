...
xtable_food<-xtable
xtable_food$ZLOG10_PCT_21_to_29_09_13<-NULL
...
xtable_alc<-xtable
xtable_alc$ZLOG10_PCT_18_to_29_09_13<-NULL
...
for (i in 1:length(colnames(ytable))){
  if(colnames(ytable)[i]=="tract B alcohol"||colnames(ytable)[i]=="user B alcohol"){
